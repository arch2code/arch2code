...
def create(prj):
    ...
    # vlTops pass.
    # A foreign-owned VlRegistrar TU #includes the V<top>.h headers of the
    # owner's build, which this build neither generates nor consults: it swaps
    # the reused IP whole. Recorded (its directory is compiled), not compiled.
    cppExcludeFiles = set()
    for row in rows:
