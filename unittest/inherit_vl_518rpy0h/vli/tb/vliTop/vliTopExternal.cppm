...
export module vlInh_vliTop.external;
...
export class vliTopExternal: public sc_module, public vliTopInverted {

    logBlock log_;

public:

    SC_HAS_PROCESS (vliTopExternal);

    vliTopExternal(sc_module_name modulename);
...
vliTopExternal::vliTopExternal(sc_module_name modulename) :
    vliTopInverted("Chnl"),
    log_(name())
