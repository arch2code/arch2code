...
export class xviTopExternal: public sc_module, public xviTopInverted {

    logBlock log_;

public:

    SC_HAS_PROCESS (xviTopExternal);

    xviTopExternal(sc_module_name modulename);
...
xviTopExternal::xviTopExternal(sc_module_name modulename) :
    xviTopInverted("Chnl"),
    log_(name())
