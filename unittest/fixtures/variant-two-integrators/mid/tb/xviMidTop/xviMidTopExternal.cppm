...
export module xviMid_xviMidTop.external;
...
export class xviMidTopExternal: public sc_module, public xviMidTopInverted {

    logBlock log_;

public:

    SC_HAS_PROCESS (xviMidTopExternal);

    xviMidTopExternal(sc_module_name modulename);
...
xviMidTopExternal::xviMidTopExternal(sc_module_name modulename) :
    xviMidTopInverted("Chnl"),
    log_(name())
