...
$(VL_OBJ_FILES): $(VL_GEN_SV_FILES) 
	verilator $(VERILATOR_OPTS) -CFLAGS $(VERILATOR_CFLAG_OPTS) -F $(REPO_ROOT)/rtl/$(PROJECTNAME).f $(subst obj_dir/V,, $(patsubst %.o, %.sv, $@)) -top $(notdir $(subst obj_dir/V,, $(patsubst %.o,%, $@)))
