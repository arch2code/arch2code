...
# default-less parameterized module cannot be a Verilated top). Each top gets its
# OWN --Mdir (obj_dir/<top>) so concurrent verilate runs never write a shared
# obj_dir; the per-assembler VlRegistrar picks up each V<top>.h from its own Mdir
# on the SystemC include path (a2c-systemc.mk drives that from A2C_VL_TOPS).
VL_OBJ_FILES = $(foreach t,$(A2C_VL_TOPS),obj_dir/$(t)/$(A2C_VL_OBJ_$(t)))
