...
[,bash]
----
./arch2code.py --yaml document/source/modules/ROOT/examples/axiDemo/project.yaml
...
[source,verilog]
----
include::example$axiDemo/systemVerilog/axiDemo.sv[]
----
...
The SystemVerilog output files; xref:#axiDemo[axiDemo.sv RTL], xref:#consumer[consumer.sv RTL], and xref:#producer[producer.sv RTL] can be found at:
[bash]
----
examples/axiDemo/rtl/
----
