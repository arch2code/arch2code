...
inline constexpr const char *name_src_trans_dest_trans_rv_tracker = "consumer.src_trans_dest_trans_rv_tracker";
inline constexpr const char *name_src_clock_dest_trans_rv_tracker = "consumer.src_clock_dest_trans_rv_tracker";
inline constexpr const char *name_src_trans_dest_clock_rv_tracker = "consumer.src_trans_dest_clock_rv_tracker";
inline constexpr const char *name_src_trans_dest_trans_rv_size = "consumer.src_trans_dest_trans_rv_size";
inline constexpr const char *name_src_clock_dest_trans_rv_size = "consumer.src_clock_dest_trans_rv_size";
inline constexpr const char *name_src_trans_dest_clock_rv_size = "consumer.src_trans_dest_clock_rv_size";
