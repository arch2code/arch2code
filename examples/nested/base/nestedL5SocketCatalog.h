#ifndef NESTEDL5_SOCKETCATALOG_H
#define NESTEDL5_SOCKETCATALOG_H
...
namespace nestedL5SocketCatalog {
...
inline constexpr const char *name_nested5 = "nestedL5.nested5";
...
#endif //NESTEDL5_SOCKETCATALOG_H
