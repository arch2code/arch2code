#ifndef LASTBLOCK_SOCKETCATALOG_H
#define LASTBLOCK_SOCKETCATALOG_H
...
namespace lastBlockSocketCatalog {
...
inline constexpr const char *name_beta = "lastBlock.beta";
inline constexpr const char *name_response = "lastBlock.response";
...
#endif //LASTBLOCK_SOCKETCATALOG_H
