#ifndef NESTEDL6_SOCKETCATALOG_H
#define NESTEDL6_SOCKETCATALOG_H
...
namespace nestedL6SocketCatalog {
...
inline constexpr const char *name_nested6 = "nestedL6.nested6";
...
#endif //NESTEDL6_SOCKETCATALOG_H
