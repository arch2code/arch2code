...
export module nested_nestedL5.base;
import nested;
...
export class nestedL5Base : public virtual blockPortBase
{
public:
...
export class nestedL5Inverted : public virtual blockPortBase
{
public:
    // dst ports
    // External->test: Test interface
