...
export module nested_nestedL4.base;
import nested;
...
export class nestedL4Base : public virtual blockPortBase
{
public:
...
export class nestedL4Inverted : public virtual blockPortBase
{
public:
    // dst ports
    // External->test: Test interface
