#ifndef SECONDSUBA_SOCKETCATALOG_H
#define SECONDSUBA_SOCKETCATALOG_H
...
namespace secondSubASocketCatalog {
...
inline constexpr const char *name_test = "secondSubA.test";
inline constexpr const char *name_primary = "secondSubA.primary";
...
#endif //SECONDSUBA_SOCKETCATALOG_H
