...
export module nested_lastBlock.base;
import nested;
...
export class lastBlockBase : public virtual blockPortBase
{
public:
...
export class lastBlockInverted : public virtual blockPortBase
{
public:
    // src ports
    // gamma->uFirst: Test interface gamma
...
export class lastBlockChannels
{
public:
    // src ports
