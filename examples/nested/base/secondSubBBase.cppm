...
export module nested_secondSubB.base;
import nested;
...
export class secondSubBBase : public virtual blockPortBase
{
public:
...
export class secondSubBInverted : public virtual blockPortBase
{
public:
    // src ports
    // beta->External: Test interface beta
...
export class secondSubBChannels
{
public:
    // src ports
    // Test interface beta
