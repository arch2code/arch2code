#ifndef NESTEDL3_SOCKETCATALOG_H
#define NESTEDL3_SOCKETCATALOG_H
...
namespace nestedL3SocketCatalog {
...
inline constexpr const char *name_nested3 = "nestedL3.nested3";
...
#endif //NESTEDL3_SOCKETCATALOG_H
