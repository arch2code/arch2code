#ifndef NESTEDL1_SOCKETCATALOG_H
#define NESTEDL1_SOCKETCATALOG_H
...
namespace nestedL1SocketCatalog {
...
inline constexpr const char *name_nested1 = "nestedL1.nested1";
...
#endif //NESTEDL1_SOCKETCATALOG_H
