...
export module nested_testContainer.base;
import nested;
...
export class testContainerBase : public virtual blockPortBase
{
public:
...
export class testContainerInverted : public virtual blockPortBase
{
public:
    // src ports
    // test->uNestedL1: Test interface
...
export class testContainerChannels
{
public:
    // src ports
    // Test interface
