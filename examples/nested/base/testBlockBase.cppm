...
export module nested_testBlock.base;
import nested;
...
export class testBlockBase : public virtual blockPortBase
{
public:
...
export class testBlockInverted : public virtual blockPortBase
{
public:
    // src ports
    // test->uTestBlock1: Test interface
...
export class testBlockChannels
{
public:
    // src ports
    // Test interface
