...
export module nested_nestedL2.base;
import nested;
...
export class nestedL2Base : public virtual blockPortBase
{
public:
...
export class nestedL2Inverted : public virtual blockPortBase
{
public:
    // dst ports
    // External->test: Test interface
