...
// GENERATED_CODE_PARAM --block=firstBlock --mode=module
// GENERATED_CODE_BEGIN --template=moduleScaffold --section=baseModuleHeader
module;
#include "systemc.h"
#include "rdy_vld_channel.h"

export module nested_firstBlock.base;
import nested;
...
export class firstBlockBase : public virtual blockPortBase
{
public:
...
export class firstBlockInverted : public virtual blockPortBase
{
public:
    // src ports
    // alpha->uSecond: Test interface alpha
...
export class firstBlockChannels
{
public:
    // src ports
