#ifndef SECONDSUBB_SOCKETCATALOG_H
#define SECONDSUBB_SOCKETCATALOG_H
...
namespace secondSubBSocketCatalog {
...
inline constexpr const char *name_test = "secondSubB.test";
inline constexpr const char *name_beta = "secondSubB.beta";
...
#endif //SECONDSUBB_SOCKETCATALOG_H
