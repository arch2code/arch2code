...
namespace {
[[maybe_unused]] int _nestedL4_registered = (register_nestedL4_variants(), 0);
} // namespace
...
nestedL4::nestedL4(sc_module_name blockName, const char * variant, blockBaseMode bbMode)
       : sc_module(blockName)
        ...
        ,uNestedL5(std::dynamic_pointer_cast<nestedL5Base>((force_link_nestedL5(), instanceFactory::createInstance(name(), "uNestedL5", "nestedL5", ""))))
// GENERATED_CODE_END
