...
#ifndef AXISOCKETMASTER_TBINCLUDESFW_H_
#define AXISOCKETMASTER_TBINCLUDESFW_H_
// 

// GENERATED_CODE_PARAM --project=axiSocketMaster --context=axiSocketMaster_tb.yaml --mode=fw
// GENERATED_CODE_BEGIN --template=headers --fileMapKey=includeFW_hdr
#include "axiStdIncludesFW.h"
namespace fw_ns::axiSocketMaster_tb {}
namespace fw_ns { using namespace axiSocketMaster_tb; }
...
// GENERATED_CODE_END
#endif //AXISOCKETMASTER_TBINCLUDESFW_H_
