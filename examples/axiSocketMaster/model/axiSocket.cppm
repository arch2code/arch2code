...
export module axiSocketMaster_axiSocket.block;
...
void register_axiSocket_variants() {
    instanceFactory::registerBlock("axiSocket_model", [](const char * blockName, const char * variant, blockBaseMode bbMode) -> std::shared_ptr<blockBase> { return static_cast<std::shared_ptr<blockBase>>(std::make_shared<axiSocket>(blockName, variant, bbMode)); }, "", "axiSocketMaster");
}
