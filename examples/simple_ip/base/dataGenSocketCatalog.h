#ifndef DATAGEN_SOCKETCATALOG_H
#define DATAGEN_SOCKETCATALOG_H
...
namespace dataGenSocketCatalog {
...
inline constexpr const char *name_out = "dataGen.out";
