`ifndef _SIMPLE_IP_HDL_SV_WRAPPER_SV_GUARD_
`define _SIMPLE_IP_HDL_SV_WRAPPER_SV_GUARD_

// GENERATED_CODE_PARAM --block=simple_ip
// GENERATED_CODE_BEGIN --template=module_hdl_sv_wrapper

module simple_ip_hdl_sv_wrapper
...
endmodule : simple_ip_hdl_sv_wrapper

// GENERATED_CODE_END

`endif // _SIMPLE_IP_HDL_SV_WRAPPER_SV_GUARD_
