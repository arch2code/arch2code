...
export module axi4sDemo_axi4s_s_drv.block;
...
void register_axi4s_s_drv_variants() {
    instanceFactory::registerBlock("axi4s_s_drv_model", [](const char * blockName, const char * variant, blockBaseMode bbMode) -> std::shared_ptr<blockBase> { return static_cast<std::shared_ptr<blockBase>>(std::make_shared<axi4s_s_drv>(blockName, variant, bbMode)); }, "", "axi4sDemo");
}
