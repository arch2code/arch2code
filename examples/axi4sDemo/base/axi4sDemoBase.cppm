...
export class axi4sDemoBase : public virtual blockPortBase
{
public:
...
export class axi4sDemoInverted : public virtual blockPortBase
{
public:
    // src ports
    // axi4str_t2->u_axi4s_s_drv: AXI4 Stream Interface Type 2 (64 bits data)
...
export class axi4sDemoChannels
{
public:
    // src ports
