...
// GENERATED_CODE_PARAM --block=axi4sDemo_tb --excludeInst=u_axi4sDemo --mode=module
...
export module axi4sDemo.external;
...
export class axi4sDemoExternal: public sc_module, public axi4sDemoInverted {
...
axi4sDemoExternal::axi4sDemoExternal(sc_module_name modulename) :
   ...
   ,u_axi4s_m_drv(std::dynamic_pointer_cast<axi4s_m_drvBase>(instanceFactory::createInstance(name(), "u_axi4s_m_drv", "axi4s_m_drv", "", "axi4sDemo")))
   ,u_axi4s_s_drv(std::dynamic_pointer_cast<axi4s_s_drvBase>(instanceFactory::createInstance(name(), "u_axi4s_s_drv", "axi4s_s_drv", "", "axi4sDemo")))
// GENERATED_CODE_END
