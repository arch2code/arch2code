    ...
    _ipLeaf_vl_registrar() {
        instanceFactory::registerBlock(
            ...
            [](const char * blockName, const char * variant, blockBaseMode bbMode) -> std::shared_ptr<blockBase> {
                return static_cast<std::shared_ptr<blockBase>>(std::make_shared<ipLeaf_hdl_sc_wrapper<VipLeaf_variantLeaf0_hdl_sv_wrapper, ip_test_ipLeafVariantLeaf0Config>>(blockName, variant, bbMode));
            },
