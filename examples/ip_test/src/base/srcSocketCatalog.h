...
inline constexpr const char *name_out0 = "src.out0";
inline constexpr const char *name_out1 = "src.out1";
inline constexpr const char *name_out2 = "src.out2";
inline constexpr const char *name_out3 = "src.out3";
