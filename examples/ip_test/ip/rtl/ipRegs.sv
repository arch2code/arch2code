...
module ip_ipRegs
    ...
    `DFFEN_DOM(clk, rst_n, ipFixedMem_data[7:0], nxt_ipFixedMem_data[7:0], ipFixedMem_update_0)
    ...
    `DFFEN_DOM(clk, rst_n, ipNonConstMem_data[7:0], nxt_ipNonConstMem_data[7:0], ipNonConstMem_update_0)
