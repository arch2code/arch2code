#ifndef IP_SOCKETCATALOG_H
#define IP_SOCKETCATALOG_H
...
inline constexpr const char *name_ipDataIf = "ip.ipDataIf";
inline constexpr const char *name_regs = "ip.regs";
