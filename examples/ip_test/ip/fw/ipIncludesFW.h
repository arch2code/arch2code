...
struct ipDataSt_v {
    ...
    ipDataSt_v() { memset(this, 0, sizeof(ipDataSt_v)); }
...
struct ipCfgSt_v {
    ...
    ipCfgSt_v() { memset(this, 0, sizeof(ipCfgSt_v)); }
...
struct ipMemSt_v {
    ...
    ipMemSt_v() { memset(this, 0, sizeof(ipMemSt_v)); }
...
struct ipMemAddrSt_v {
    ...
    ipMemAddrSt_v() { memset(this, 0, sizeof(ipMemAddrSt_v)); }
...
struct ipBurstSt_v {
    ...
    ipBurstSt_v() { memset(this, 0, sizeof(ipBurstSt_v)); }
...
struct ipDerivedMemAddrSt_v {
    ...
    ipDerivedMemAddrSt_v() { memset(this, 0, sizeof(ipDerivedMemAddrSt_v)); }
...
struct ipParamNestedSt_v {
    ...
    ipParamNestedSt_v() { memset(this, 0, sizeof(ipParamNestedSt_v)); }
...
struct ipSignedParamSt_v {
    ...
    ipSignedParamSt_v() { memset(this, 0, sizeof(ipSignedParamSt_v)); }
