...
// GENERATED_CODE_PARAM --block=bridgeStdTop_tb --excludeInst=u_bridgeStdTop --mode=module
...
export module ipBridge_bridgeStdTop.external;
...
export class bridgeStdTopExternal: public sc_module, public bridgeStdTopInverted {
