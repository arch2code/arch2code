`ifndef IPBRIDGE_IP_VARIANT1_HDL_SV_WRAPPER_SV_GUARD_
`define IPBRIDGE_IP_VARIANT1_HDL_SV_WRAPPER_SV_GUARD_

// GENERATED_CODE_PARAM --block=ip --parent=ipBridge --variant=variant1
// GENERATED_CODE_BEGIN --template=module_hdl_sv_wrapper

`include "ip_hdl_sv_wrapper.svh"

module ipBridge_ip_variant1_hdl_sv_wrapper
...
endmodule : ipBridge_ip_variant1_hdl_sv_wrapper

// GENERATED_CODE_END

`endif // IPBRIDGE_IP_VARIANT1_HDL_SV_WRAPPER_SV_GUARD_
