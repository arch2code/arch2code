...
export class bridgeDriverBase : public virtual blockPortBase
{
public:
...
export class bridgeDriverInverted : public virtual blockPortBase
{
public:
    // src ports
    // data8If->uBridge: Non-parameterized 8-bit Q10 bridge data interface
...
export class bridgeDriverChannels
{
public:
    // src ports
