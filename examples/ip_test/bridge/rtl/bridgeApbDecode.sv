...
`SCFF_DOM(clk, rst_n, apbReg_uBridgeIp1_psel, apbReg_uBridgeIp1_next_psel, apbReg_uBridgeIp1.pready)
...
`SCFF_DOM(clk, rst_n, apbReg_uBridgeIp0_psel, apbReg_uBridgeIp0_next_psel, apbReg_uBridgeIp0.pready)
