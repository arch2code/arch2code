...
`SCFF_DOM(clk, rst_n, apbReg_uBridge_psel, apbReg_uBridge_next_psel, apbReg_uBridge.pready)
...
`SCFF_DOM(clk, rst_n, apbReg_uIp1_psel, apbReg_uIp1_next_psel, apbReg_uIp1.pready)
...
`SCFF_DOM(clk, rst_n, apbReg_uIp0_psel, apbReg_uIp0_next_psel, apbReg_uIp0.pready)
