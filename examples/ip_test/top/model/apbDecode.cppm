...
export module ip_test_apbDecode.block;
...
void register_apbDecode_variants() {
    instanceFactory::registerBlock("apbDecode_model", [](const char * blockName, const char * variant, blockBaseMode bbMode) -> std::shared_ptr<blockBase> { return static_cast<std::shared_ptr<blockBase>>(std::make_shared<apbDecode>(blockName, variant, bbMode)); }, "", "ip_test");
}

namespace {
[[maybe_unused]] A2C_REGISTRATION_RETAIN int _apbDecode_registered = (register_apbDecode_variants(), 0);
} // namespace
