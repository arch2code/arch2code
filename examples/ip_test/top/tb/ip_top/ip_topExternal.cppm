...
// GENERATED_CODE_PARAM --block=ip_top_tb --excludeInst=u_ip_top --mode=module
...
export module ip_test_ip_top.external;
...
export class ip_topExternal: public sc_module, public ip_topInverted {
