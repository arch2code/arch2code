#ifndef CLKCONSUMER_HDL_SC_WRAPPER_H_
#define CLKCONSUMER_HDL_SC_WRAPPER_H_
...
class clkConsumer_hdl_sc_wrapper: public sc_module, public blockBase, public clkConsumerBase {
...
public:
    ...
    SC_HAS_PROCESS (clkConsumer_hdl_sc_wrapper);

    clkConsumer_hdl_sc_wrapper(sc_module_name modulename, const char *variant, blockBaseMode bbMode) :
...
#endif // CLKCONSUMER_HDL_SC_WRAPPER_H_
