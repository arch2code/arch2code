    ...
    _blockF_vl_registrar() {
        instanceFactory::registerBlock(
            ...
            [](const char * blockName, const char * variant, blockBaseMode bbMode) -> std::shared_ptr<blockBase> {
                return static_cast<std::shared_ptr<blockBase>>(std::make_shared<blockF_hdl_sc_wrapper<VblockF_variant0_hdl_sv_wrapper, mixed_blockFVariant0Config>>(blockName, variant, bbMode));
            },
            "variant0", "mixed");
        instanceFactory::registerBlock(
            "blockF_verif",
        ...
        instanceFactory::registerBlock(
            "blockF_verif",
            [](const char * blockName, const char * variant, blockBaseMode bbMode) -> std::shared_ptr<blockBase> {
                return static_cast<std::shared_ptr<blockBase>>(std::make_shared<blockF_hdl_sc_wrapper<VblockF_variant1_hdl_sv_wrapper, mixed_blockFVariant1Config>>(blockName, variant, bbMode));
            },
            "variant1", "mixed");
        instanceFactory::registerBlock(
            "blockF_verif",
