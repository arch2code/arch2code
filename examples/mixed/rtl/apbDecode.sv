...
apbAddrSt paddr_q;
`DFF_DOM(clk, rst_n, paddr_q, cpu_main.paddr)
apbDataSt pwdata_q;
`DFF_DOM(clk, rst_n, pwdata_q, cpu_main.pwdata)
logic penable_q;
`DFF_DOM(clk, rst_n, penable_q, cpu_main.penable)
logic pwrite_q;
`DFF_DOM(clk, rst_n, pwrite_q, cpu_main.pwrite)
...
`SCFF_DOM(clk, rst_n, apbReg_uBlockG_psel, apbReg_uBlockG_next_psel, apbReg_uBlockG.pready)
...
`SCFF_DOM(clk, rst_n, apbReg_uBlockB_psel, apbReg_uBlockB_next_psel, apbReg_uBlockB.pready)
...
`SCFF_DOM(clk, rst_n, apbReg_uBlockA_psel, apbReg_uBlockA_next_psel, apbReg_uBlockA.pready)
...
`DFF_DOM(clk, rst_n, pready, cpu_main_next_pready)
`DFF_DOM(clk, rst_n, prdata, cpu_main_next_prdata)
`DFF_DOM(clk, rst_n, pslverr, cpu_main_next_pslverr)
