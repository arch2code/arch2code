...
//register addresses
#define REG_BLOCKB_RWD                      0xf8
#define REG_BLOCKB_ROBSIZE                  0x100
#define REG_BLOCKA_ROA                      0x78
#define REG_BLOCKA_BLOCKATABLELOCAL         0x50
#define REG_BLOCKB_BLOCKBTABLEEXT           0xd0
