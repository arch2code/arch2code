...
// GENERATED_CODE_PARAM --project=mixed --context=mixed.yaml --mode=module
...
export namespace mixed_test_ns {
...
} // namespace mixed_test_ns

// GENERATED_CODE_END
// GENERATED_CODE_BEGIN --template=structures --section=testStructsCPP
export namespace mixed_test_ns {
using namespace mixed_ns;
struct mixedTestConfigDefault {
    static constexpr uint32_t bob = 16;
    static constexpr uint32_t fred = 0;
};
struct mixedTestConfigMid {
    static constexpr uint32_t bob = 8;
    static constexpr uint32_t fred = 1;
};
struct mixedTestConfigMax {
    static constexpr uint32_t bob = 16;
    static constexpr uint32_t fred = 1;
};
...
void test_mixed_structs::test(void) {
    ...
    roundTrip<aSt>("aSt", patterns);
    roundTrip<aASt>("aASt", patterns);
    roundTrip<aRegSt>("aRegSt", patterns);
    roundTrip<dRegSt>("dRegSt", patterns);
    roundTrip<dSt>("dSt", patterns);
    roundTrip<bigSt>("bigSt", patterns);
    roundTrip<nestedSt>("nestedSt", patterns);
    roundTrip<bSizeRegSt>("bSizeRegSt", patterns);
    roundTrip<bSizeSt>("bSizeSt", patterns);
    roundTrip<apbAddrSt>("apbAddrSt", patterns);
    roundTrip<apbDataSt>("apbDataSt", patterns);
    roundTrip<cSt>("cSt", patterns);
    roundTrip<test1St>("test1St", patterns);
    roundTrip<test2St>("test2St", patterns);
    roundTrip<test3St>("test3St", patterns);
    roundTrip<test4St>("test4St", patterns);
    roundTrip<test5St>("test5St", patterns);
    roundTrip<test6St>("test6St", patterns);
    roundTrip<test7St>("test7St", patterns);
    roundTrip<test8St>("test8St", patterns);
    roundTrip<test9St>("test9St", patterns);
    roundTrip<signedTestSt>("signedTestSt", signedPatterns);
    roundTrip<mixedSignedSt>("mixedSignedSt", signedPatterns);
    roundTrip<signedArraySt>("signedArraySt", signedPatterns);
    roundTrip<nonByteAlignedSignedSt>("nonByteAlignedSignedSt", signedPatterns);
    roundTrip<complexMixedSt>("complexMixedSt", signedPatterns);
    roundTrip<edgeCaseSignedSt>("edgeCaseSignedSt", signedPatterns);
    roundTrip<mixedArraySignedSt>("mixedArraySignedSt", signedPatterns);
    roundTrip<test37BitRegSt>("test37BitRegSt", patterns);
    roundTrip<log2TestSt>("log2TestSt", signedPatterns);
    roundTrip<nestedLog2St>("nestedLog2St", signedPatterns);
    roundTrip<wideLog2St>("wideLog2St", signedPatterns);
}
} // namespace mixed_test_ns
