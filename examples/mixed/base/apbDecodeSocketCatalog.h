...
inline constexpr const char *name_apbReg_uBlockG = "apbDecode.apbReg_uBlockG";
inline constexpr const char *observe_name_apbReg_uBlockG = "apbDecode.apbReg_uBlockG_obs";
