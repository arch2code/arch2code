#ifndef BLOCKGREGS_SOCKETCATALOG_H
#define BLOCKGREGS_SOCKETCATALOG_H
...
namespace blockGRegsSocketCatalog {

inline constexpr std::array<const char *, 0> listen_names{};
inline constexpr std::array<const char *, 0> sync_names{};

inline constexpr const char *name_apbReg = "blockGRegs.apbReg";
inline constexpr const char *name_rwG = "blockGRegs.rwG";
...
#endif //BLOCKGREGS_SOCKETCATALOG_H
