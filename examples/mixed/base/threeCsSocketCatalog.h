#ifndef THREECS_SOCKETCATALOG_H
#define THREECS_SOCKETCATALOG_H
...
namespace threeCsSocketCatalog {
...
inline constexpr const char *name_see0 = "threeCs.see0";
inline constexpr const char *name_see1 = "threeCs.see1";
inline constexpr const char *name_see2 = "threeCs.see2";
