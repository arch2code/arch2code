...
export module mixed_blockB.base;
import mixed;
...
export class blockBBase : public virtual blockPortBase
{
public:
...
export class blockBInverted : public virtual blockPortBase
{
public:
    // dst ports
    // uBlockA->aStuffIf: An interface for A
