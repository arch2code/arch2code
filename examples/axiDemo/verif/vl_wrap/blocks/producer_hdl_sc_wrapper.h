...
public:
    ...
    struct registerBlock
    {
        registerBlock()
        {
            ...
            instanceFactory::registerBlock(
                "producer_verif", [](const char *blockName, const char *variant, blockBaseMode bbMode) -> std::shared_ptr<blockBase> {
    ...
    axi_read_src_bfm<axiAddrSt, axiDataSt, sc_bv<32>, sc_bv<32>> axiRd2_bfm;
    axi_read_src_bfm<axiAddrSt, axiDataSt, sc_bv<32>, sc_bv<32>> axiRd3_bfm;
    axi_write_src_bfm<axiAddrSt, axiDataSt, axiStrobeSt, sc_bv<32>, sc_bv<32>, sc_bv<4>> axiWr0_bfm;
