...
//module as defined by block: hierVlDemo
module hierVlDemo
    ...
    always_ff @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            if (in_fire) begin
                ...
                assert(check_parity_t1(axis4_t1.tdata, axis4_t1.tuser.parity)) else $error("hierVlDemo: Input parity error on tdata/tuser");
