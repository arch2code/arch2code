...
export class axi4s_s_drvBase : public virtual blockPortBase
{
public:
    virtual ~axi4s_s_drvBase() = default;
    // dst ports
    // u_hierVlDemo->axi4str_t2: AXI4 Stream Interface Type 2 (64 bits data)
...
export class axi4s_s_drvInverted : public virtual blockPortBase
{
public:
    // dst ports
    // u_hierVlDemo->axi4str_t2: AXI4 Stream Interface Type 2 (64 bits data)
...
export class axi4s_s_drvChannels
{
public:
    // dst ports
