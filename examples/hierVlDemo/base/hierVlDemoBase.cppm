...
export class hierVlDemoBase : public virtual blockPortBase
{
public:
    virtual ~hierVlDemoBase() = default;
    // src ports
    ...
    hierVlDemoBase(std::string name, const char * variant) :
        axis4_t2("axis4_t2")
        ,axis4_t1("axis4_t1")
    {};
...
export class hierVlDemoInverted : public virtual blockPortBase
{
public:
    // src ports
    // axi4str_t2->u_axi4s_s_drv: AXI4 Stream Interface Type 2 (64 bits data)
    ...
    hierVlDemoInverted(std::string name) :
...
export class hierVlDemoChannels
{
public:
    // src ports
