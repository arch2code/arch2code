`ifndef _HIERVLDEMO_HDL_SV_WRAPPER_SV_GUARD_
`define _HIERVLDEMO_HDL_SV_WRAPPER_SV_GUARD_

// GENERATED_CODE_PARAM --block=hierVlDemo
// GENERATED_CODE_BEGIN --template=module_hdl_sv_wrapper

module hierVlDemo_hdl_sv_wrapper
    // Generated Import package statement(s)
    import hierVlDemo_tb_package::*;
(
    // axi4_stream_if.dst
...
endmodule : hierVlDemo_hdl_sv_wrapper

// GENERATED_CODE_END

`endif // _HIERVLDEMO_HDL_SV_WRAPPER_SV_GUARD_
