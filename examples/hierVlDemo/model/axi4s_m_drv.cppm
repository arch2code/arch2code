...
void register_axi4s_m_drv_variants() {
    instanceFactory::registerBlock("axi4s_m_drv_model", [](const char * blockName, const char * variant, blockBaseMode bbMode) -> std::shared_ptr<blockBase> { return static_cast<std::shared_ptr<blockBase>>(std::make_shared<axi4s_m_drv>(blockName, variant, bbMode)); }, "", "hierVlDemo");
}
