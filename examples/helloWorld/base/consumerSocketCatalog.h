...
inline constexpr const char *name_test_rdy_vld = "consumer.test_rdy_vld";
inline constexpr const char *name_test_req_ack = "consumer.test_req_ack";
inline constexpr const char *name_test_push_ack = "consumer.test_push_ack";
inline constexpr const char *name_test_pop_ack = "consumer.test_pop_ack";
