...
// === Testbench config registration (helloWorldConfig) ===
...
void register_helloWorldConfig() {
...
namespace {
[[maybe_unused]] A2C_REGISTRATION_RETAIN int _helloWorldConfig_registered = (register_helloWorldConfig(), 0);
} // namespace
