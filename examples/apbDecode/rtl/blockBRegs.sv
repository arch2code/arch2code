...
module apbDecode_blockBRegs
    ...
    `DFFREN_DOM(clk, rst_n, rwUn0B_reg[23:0], apbReg.pwdata[23:0], rwUn0B_reg_update_0, 24'h00000000)
    ...
    `DFFEN_DOM(clk, rst_n, blockBTable_data[31:0], nxt_blockBTable_data[31:0], blockBTable_update_0)
    `DFFEN_DOM(clk, rst_n, blockBTable_data[63:32], nxt_blockBTable_data[63:32], blockBTable_update_1)
    `DFFEN_DOM(clk, rst_n, blockBTable_data[95:64], nxt_blockBTable_data[95:64], blockBTable_update_2)
