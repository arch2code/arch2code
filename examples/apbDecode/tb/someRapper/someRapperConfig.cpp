...
// === Testbench config registration (someRapperConfig) ===
...
void register_someRapperConfig() {
...
namespace {
[[maybe_unused]] A2C_REGISTRATION_RETAIN int _someRapperConfig_registered = (register_someRapperConfig(), 0);
} // namespace
