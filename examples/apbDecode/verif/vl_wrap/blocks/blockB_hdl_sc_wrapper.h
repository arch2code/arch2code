#ifndef BLOCKB_HDL_SC_WRAPPER_H_
#define BLOCKB_HDL_SC_WRAPPER_H_
...
class blockB_hdl_sc_wrapper: public sc_module, public blockBase, public blockBBase {
...
public:
    ...
    struct registerBlock
    {
        registerBlock()
        {
            ...
            instanceFactory::registerBlock(
                "blockB_verif", [](const char *blockName, const char *variant, blockBaseMode bbMode) -> std::shared_ptr<blockBase> {
    ...
    blockB_hdl_sc_wrapper(sc_module_name modulename, const char *variant, blockBaseMode bbMode) :
...
#endif // BLOCKB_HDL_SC_WRAPPER_H_
