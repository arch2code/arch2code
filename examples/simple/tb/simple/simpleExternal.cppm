...
// GENERATED_CODE_PARAM --block=simple_tb --excludeInst=u_simple --mode=module
...
export class simpleExternal: public sc_module, public simpleInverted {
