...
public:
    ...
    // test_push_ack->u_dut: Python-initiated push into the DUT
    push_ack_out< p2s_message_st > test_push_ack;
    // test_pop_ack->u_dut: Python-initiated pop of data derived from the last push
    pop_ack_out< p2s_response_st > test_pop_ack;
    // test_notify_ack->u_dut: Python-initiated notify into the DUT
    ...
    // u_dut->dut2Python_push_ack: DUT-initiated push into Python
    push_ack_in< p2s_message_st > dut2Python_push_ack;
    // u_dut->dut2Python_pop_ack: DUT-initiated pop of data derived from the DUT push
    pop_ack_in< p2s_response_st > dut2Python_pop_ack;
    // u_dut->dut2Python_notify_ack: DUT-initiated notify into Python
