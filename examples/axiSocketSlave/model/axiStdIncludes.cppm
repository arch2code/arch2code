...
// GENERATED_CODE_PARAM --project=axiSocketSlave --context=axiStd.yaml --mode=module
// 
...
export namespace axiSocketSlave_axiStd_ns {
//constants

} // namespace axiSocketSlave_axiStd_ns
// GENERATED_CODE_END
