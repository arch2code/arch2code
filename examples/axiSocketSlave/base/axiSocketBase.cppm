...
export module axiSocketSlave_axiSocket.base;
...
public:
    ...
    // dst ports
    // u_producer->axiRdIf: AXI Read channels; Address and Data
    axi_read_in< axiAddrSt, axiDataSt > axiRd0;
    // u_producer->axiWrIf: AXI Write channels; Address, Data, and Response
