#ifndef AXISOCKETSLAVE_TB_SOCKETCATALOG_H
#define AXISOCKETSLAVE_TB_SOCKETCATALOG_H
// 
...
namespace axiSocketSlave_tbSocketCatalog {
...
#endif //AXISOCKETSLAVE_TB_SOCKETCATALOG_H
