...
#ifndef AXISTDINCLUDESFW_H_
#define AXISTDINCLUDESFW_H_
// 

// GENERATED_CODE_PARAM --project=axiSocketSlave --context=axiStd.yaml --mode=fw
// GENERATED_CODE_BEGIN --template=headers --fileMapKey=includeFW_hdr
namespace fw_ns::axiSocketSlave_axiStd {}
namespace fw_ns { using namespace axiSocketSlave_axiStd; }
