...
xpCstBindWrap::xpCstBindWrap(sc_module_name blockName, const char * variant, blockBaseMode bbMode)
       : sc_module(blockName)
        ...
        ,uSrcA(std::dynamic_pointer_cast<xpCstSrcIncBase<xpCstBind_xpCstSrcIncDfltConfig>>(instanceFactory::createInstance(name(), "uSrcA", "xpCstSrcInc", "dflt", "xpCstBind")))
        ,uDutA(std::dynamic_pointer_cast<xpCstDutBase<xpCstDutDfltConfig>>(instanceFactory::createInstance(name(), "uDutA", "xpCstDut", "dflt", "xpCstBind")))
        ,uChkA(std::dynamic_pointer_cast<xpCstChkIncBase<xpCstBind_xpCstChkIncDfltConfig>>(instanceFactory::createInstance(name(), "uChkA", "xpCstChkInc", "dflt", "xpCstBind")))
        ,uSrcB(std::dynamic_pointer_cast<xpCstSrcOwnBase<xpCstSrcOwnUseConfig>>(instanceFactory::createInstance(name(), "uSrcB", "xpCstSrcOwn", "use", "xpCstBind")))
        ,uDutB(std::dynamic_pointer_cast<xpCstDutBase<xpCstBind_xpCstDutUseConfig>>(instanceFactory::createInstance(name(), "uDutB", "xpCstDut", "use", "xpCstBind")))
        ,uChkB(std::dynamic_pointer_cast<xpCstChkOwnBase<xpCstChkOwnUseConfig>>(instanceFactory::createInstance(name(), "uChkB", "xpCstChkOwn", "use", "xpCstBind")))
