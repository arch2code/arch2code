...
xpDeparamTop::xpDeparamTop(sc_module_name blockName, const char * variant, blockBaseMode bbMode)
       : sc_module(blockName)
        ...
        ,uGain(std::dynamic_pointer_cast<xpGainBase<xpGainV0Config>>(instanceFactory::createInstance(name(), "uGain", "xpGain", "v0", "xpDeparam")))
        ,uFilter(std::dynamic_pointer_cast<xpFilterBase<xpFilterV0Config>>(instanceFactory::createInstance(name(), "uFilter", "xpFilter", "v0", "xpDeparam")))
        ,uSink(std::dynamic_pointer_cast<xpSinkBase<xpSinkV0Config>>(instanceFactory::createInstance(name(), "uSink", "xpSink", "v0", "xpDeparam")))
