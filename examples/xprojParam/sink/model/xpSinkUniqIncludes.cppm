...
export module xpSink_xpSinkUniq;
// GENERATED_CODE_END
...
export namespace xpSink_xpSinkUniq_test_ns {
class test_xpSinkUniq_structs {
public:
...
} // namespace xpSink_xpSinkUniq_test_ns

// GENERATED_CODE_END
// GENERATED_CODE_BEGIN --template=structures --section=testStructsCPP
export namespace xpSink_xpSinkUniq_test_ns {
using namespace xpSink_xpSinkUniq_ns;
struct xpSinkUniqTestConfigDefault {
    static constexpr uint32_t SK_PIXEL_WIDTH = 8;
};
struct xpSinkUniqTestConfigMid {
    static constexpr uint32_t SK_PIXEL_WIDTH = 16;
};
struct xpSinkUniqTestConfigMax {
    static constexpr uint32_t SK_PIXEL_WIDTH = 32;
};
std::string test_xpSinkUniq_structs::name(void) { return "test_xpSinkUniq_structs"; }
void test_xpSinkUniq_structs::test(void) {
    std::vector<uint8_t> patterns{0x6a, 0xa6};
    std::vector<uint8_t> signedPatterns{0x00, 0x6a, 0xa6, 0x77, 0x88, 0x55, 0xAA, 0xFF};
    cout << "Running " << name() << endl;
    roundTrip<skVideoSt<xpSinkUniqTestConfigDefault>>("skVideoSt", patterns);
    roundTrip<skVideoSt<xpSinkUniqTestConfigMid>>("skVideoSt", patterns);
    roundTrip<skVideoSt<xpSinkUniqTestConfigMax>>("skVideoSt", patterns);
}
} // namespace xpSink_xpSinkUniq_test_ns
