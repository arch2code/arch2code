...
export module xpSink;
// GENERATED_CODE_END
// GENERATED_CODE_BEGIN --template=headers

// GENERATED_CODE_END
// GENERATED_CODE_BEGIN --template=includes --section=constants
export namespace xpSink_ns {
//constants
...
export namespace xpSink_test_ns {
class test_xpSink_structs {
public:
...
} // namespace xpSink_test_ns

// GENERATED_CODE_END
// GENERATED_CODE_BEGIN --template=structures --section=testStructsCPP
export namespace xpSink_test_ns {
using namespace xpSink_ns;
struct xpSinkTestConfigDefault {
    static constexpr uint32_t PIXEL_WIDTH = 8;
};
struct xpSinkTestConfigMid {
    static constexpr uint32_t PIXEL_WIDTH = 16;
};
struct xpSinkTestConfigMax {
    static constexpr uint32_t PIXEL_WIDTH = 32;
};
std::string test_xpSink_structs::name(void) { return "test_xpSink_structs"; }
void test_xpSink_structs::test(void) {
    std::vector<uint8_t> patterns{0x6a, 0xa6};
    std::vector<uint8_t> signedPatterns{0x00, 0x6a, 0xa6, 0x77, 0x88, 0x55, 0xAA, 0xFF};
    cout << "Running " << name() << endl;
    roundTrip<videoSt<xpSinkTestConfigDefault>>("videoSt", patterns);
    roundTrip<videoSt<xpSinkTestConfigMid>>("videoSt", patterns);
    roundTrip<videoSt<xpSinkTestConfigMax>>("videoSt", patterns);
}
} // namespace xpSink_test_ns
