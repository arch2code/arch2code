...
xpUniqTop::xpUniqTop(sc_module_name blockName, const char * variant, blockBaseMode bbMode)
       : sc_module(blockName)
        ...
        ,uGain(std::dynamic_pointer_cast<xpGainUniqBase<xpGainUniqV0Config>>(instanceFactory::createInstance(name(), "uGain", "xpGainUniq", "v0", "xpUniq")))
        ,uFilter(std::dynamic_pointer_cast<xpFilterUniqBase<xpFilterUniqV0Config>>(instanceFactory::createInstance(name(), "uFilter", "xpFilterUniq", "v0", "xpUniq")))
        ,uSink(std::dynamic_pointer_cast<xpSinkUniqBase<xpSinkUniqV0Config>>(instanceFactory::createInstance(name(), "uSink", "xpSinkUniq", "v0", "xpUniq")))
