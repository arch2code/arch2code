...
xpDpWrap<Config>::xpDpWrap(sc_module_name blockName, const char * variant, blockBaseMode bbMode)
       : sc_module(blockName)
        ...
        ,uSrc(std::dynamic_pointer_cast<xpDpSrcBase<xpDpTop_xpDpSrcCustomerConfig>>(instanceFactory::createInstance(name(), "uSrc", "xpDpSrc", "customer", "xpDpTop")))
        ,uMid(std::dynamic_pointer_cast<xpDpMidBase<xpDpTop_xpDpMidCustomerConfig<Config>>>(instanceFactory::createInstance<xpDpMid<xpDpTop_xpDpMidCustomerConfig<Config>>>(name(), "uMid", "xpDpMid", "customer", "xpDpTop")))
        ,uChk(std::dynamic_pointer_cast<xpDpChkBase<xpDpTop_xpDpChkCustomerConfig>>(instanceFactory::createInstance(name(), "uChk", "xpDpChk", "customer", "xpDpTop")))
        ,uMid2(std::dynamic_pointer_cast<xpDpMidBase<xpDpTop_xpDpMidCustomer2Config>>(instanceFactory::createInstance(name(), "uMid2", "xpDpMid", "customer2", "xpDpTop")))
        ,uLeafX(std::dynamic_pointer_cast<xpDpLeafBase<xpDpLeafDefaultConfig>>(instanceFactory::createInstance(name(), "uLeafX", "xpDpLeaf", "customer", "xpDpTop")))
        ,uChkX(std::dynamic_pointer_cast<xpDpChkBase<xpDpTop_xpDpChkLeafXConfig>>(instanceFactory::createInstance(name(), "uChkX", "xpDpChk", "leafX", "xpDpTop")))
        ,uChk2(std::dynamic_pointer_cast<xpDpChkBase<xpDpTop_xpDpChkCustomer2Config>>(instanceFactory::createInstance(name(), "uChk2", "xpDpChk", "customer2", "xpDpTop")))
        ,uMid3(std::dynamic_pointer_cast<xpDpMidBase<xpDpTop_xpDpMidCustomer3Config>>(instanceFactory::createInstance(name(), "uMid3", "xpDpMid", "customer3", "xpDpTop")))
        ,uChk3(std::dynamic_pointer_cast<xpDpChkBase<xpDpTop_xpDpChkCustomer3Config>>(instanceFactory::createInstance(name(), "uChk3", "xpDpChk", "customer3", "xpDpTop")))
