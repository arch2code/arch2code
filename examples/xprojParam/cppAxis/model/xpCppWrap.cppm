...
xpCppWrap<Config>::xpCppWrap(sc_module_name blockName, const char * variant, blockBaseMode bbMode)
       : sc_module(blockName)
        ...
        ,uLeafEq(std::dynamic_pointer_cast<xpCppLeafEqBase<xpCppLeafEqV0Config>>(instanceFactory::createInstance(name(), "uLeafEq", "xpCppLeafEq", "v0", "xpCppAxis")))
        ,uLeafOrder(std::dynamic_pointer_cast<xpCppLeafOrderBase<xpCppLeafOrderV0Config>>(instanceFactory::createInstance(name(), "uLeafOrder", "xpCppLeafOrder", "v0", "xpCppAxis")))
        ,uLeafSign(std::dynamic_pointer_cast<xpCppLeafSignBase<xpCppLeafSignV0Config>>(instanceFactory::createInstance(name(), "uLeafSign", "xpCppLeafSign", "v0", "xpCppAxis")))
        ,uLeafNest(std::dynamic_pointer_cast<xpCppLeafNestBase<xpCppLeafNestV0Config>>(instanceFactory::createInstance(name(), "uLeafNest", "xpCppLeafNest", "v0", "xpCppAxis")))
