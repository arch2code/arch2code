...
REPO_ROOT = $(A2C_ROOT)/examples/xprojParam/filterShared

PROJECTNAME = xpFilterShared
...
TB_TOP_MODULE = xpFilterShared
HDL_TOP_MODULE = xpFilterShared

A2C_PRJ_YAML = $(REPO_ROOT)/prj/yaml/xpFilterSharedProject.yaml
