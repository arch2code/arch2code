...
REPO_ROOT = $(A2C_ROOT)/examples/xprojParam/filter

PROJECTNAME = xpFilter
...
TB_TOP_MODULE = xpFilter
HDL_TOP_MODULE = xpFilter

A2C_PRJ_YAML = $(REPO_ROOT)/prj/yaml/xpFilterProject.yaml
