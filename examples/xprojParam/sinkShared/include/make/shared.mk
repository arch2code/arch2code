...
REPO_ROOT = $(A2C_ROOT)/examples/xprojParam/sinkShared

PROJECTNAME = xpSinkShared
...
TB_TOP_MODULE = xpSinkShared
HDL_TOP_MODULE = xpSinkShared

A2C_PRJ_YAML = $(REPO_ROOT)/prj/yaml/xpSinkSharedProject.yaml
