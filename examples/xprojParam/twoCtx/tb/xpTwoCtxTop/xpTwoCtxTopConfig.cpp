...
// GENERATED_CODE_PARAM --block=xpTwoCtxTop
...
class xpTwoCtxTopConfig : public testBenchConfigBase
{
public:
    virtual ~xpTwoCtxTopConfig() override = default; // Explicit Virtual Destructor
...
protected:
    ...
    std::shared_ptr<blockBase> createTbTop(void) { return instanceFactory::createInstance("", "tb", "xpTwoCtxTopTestbench", "", "xpTwoCtx"); }
public:
// GENERATED_CODE_END
...
// === Testbench config registration (xpTwoCtxTopConfig) ===
...
void register_xpTwoCtxTopConfig() {
    testBenchConfigFactory::registerTestBenchConfig("xpTwoCtxTop", [](std::string) -> std::shared_ptr<testBenchConfigBase> { return static_cast<std::shared_ptr<testBenchConfigBase>> (std::make_shared<xpTwoCtxTopConfig>());}, is_default_testbench_v<xpTwoCtxTopConfig>);
}

namespace {
[[maybe_unused]] A2C_REGISTRATION_RETAIN int _xpTwoCtxTopConfig_registered = (register_xpTwoCtxTopConfig(), 0);
} // namespace
