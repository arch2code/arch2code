...
// GENERATED_CODE_PARAM --block=xpDpMidStdTop
...
class xpDpMidStdTopConfig : public testBenchConfigBase
{
public:
    virtual ~xpDpMidStdTopConfig() override = default; // Explicit Virtual Destructor
...
protected:
    ...
    std::shared_ptr<blockBase> createTbTop(void) { return instanceFactory::createInstance("", "tb", "xpDpMidStdTopTestbench", "", "xpDpMid"); }
public:
// GENERATED_CODE_END
...
// === Testbench config registration (xpDpMidStdTopConfig) ===
...
void register_xpDpMidStdTopConfig() {
    testBenchConfigFactory::registerTestBenchConfig("xpDpMidStdTop", [](std::string) -> std::shared_ptr<testBenchConfigBase> { return static_cast<std::shared_ptr<testBenchConfigBase>> (std::make_shared<xpDpMidStdTopConfig>());}, is_default_testbench_v<xpDpMidStdTopConfig>);
}

namespace {
[[maybe_unused]] A2C_REGISTRATION_RETAIN int _xpDpMidStdTopConfig_registered = (register_xpDpMidStdTopConfig(), 0);
} // namespace
