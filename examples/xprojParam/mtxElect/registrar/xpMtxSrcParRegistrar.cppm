...
export module xpMtxElect.xpMtxIp_xpMtxSrcPar.registrar;
    ...
    _xpMtxSrcPar_registrar() {
        instanceFactory::registerBlock(
            ...
            [](const char * blockName, const char * variant, blockBaseMode bbMode) -> std::shared_ptr<blockBase> {
                return static_cast<std::shared_ptr<blockBase>>(std::make_shared<xpMtxSrcPar<xpMtxIp_xpMtxSrcParV0Config>>(blockName, variant, bbMode));
            },
            "v0", "xpMtxElect.xpMtxElect_xpMtxElectWrap.xpMtxIp_xpMtxSrcPar");
        instanceFactory::registerBlock(
            "xpMtxSrcPar_model",
            [](const char * blockName, const char * variant, blockBaseMode bbMode) -> std::shared_ptr<blockBase> {
                return static_cast<std::shared_ptr<blockBase>>(std::make_shared<xpMtxSrcPar<xpMtxIp_xpMtxSrcParV0Config>>(blockName, variant, bbMode));
