...
// GENERATED_CODE_PARAM --block=xpMtxElectTop
...
class xpMtxElectTopConfig : public testBenchConfigBase
{
public:
    virtual ~xpMtxElectTopConfig() override = default; // Explicit Virtual Destructor
...
protected:
    ...
    std::shared_ptr<blockBase> createTbTop(void) { return instanceFactory::createInstance("", "tb", "xpMtxElectTopTestbench", "", "xpMtxElect"); }
public:
// GENERATED_CODE_END
...
// === Testbench config registration (xpMtxElectTopConfig) ===
...
void register_xpMtxElectTopConfig() {
    testBenchConfigFactory::registerTestBenchConfig("xpMtxElectTop", [](std::string) -> std::shared_ptr<testBenchConfigBase> { return static_cast<std::shared_ptr<testBenchConfigBase>> (std::make_shared<xpMtxElectTopConfig>());}, is_default_testbench_v<xpMtxElectTopConfig>);
}

namespace {
[[maybe_unused]] A2C_REGISTRATION_RETAIN int _xpMtxElectTopConfig_registered = (register_xpMtxElectTopConfig(), 0);
} // namespace
