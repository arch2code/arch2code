...
xpMtxLitWrap::xpMtxLitWrap(sc_module_name blockName, const char * variant, blockBaseMode bbMode)
       : sc_module(blockName)
        ...
        ,uDstLP(std::dynamic_pointer_cast<xpMtxDstParBase<xpMtxDstParV0Config>>(instanceFactory::createInstance(name(), "uDstLP", "xpMtxDstPar", "v0", "xpMtxLit")))
        ,uSrcPL(std::dynamic_pointer_cast<xpMtxSrcParBase<xpMtxSrcParV0Config>>(instanceFactory::createInstance(name(), "uSrcPL", "xpMtxSrcPar", "v0", "xpMtxLit")))
        ,uDstPL(std::dynamic_pointer_cast<xpMtxDstLitBase>(instanceFactory::createInstance(name(), "uDstPL", "xpMtxDstLit", "", "xpMtxIp")))
        ,uSrcPP(std::dynamic_pointer_cast<xpMtxSrcParBase<xpMtxSrcParV0Config>>(instanceFactory::createInstance(name(), "uSrcPP", "xpMtxSrcPar", "v0", "xpMtxLit")))
        ,uDstPP(std::dynamic_pointer_cast<xpMtxDstParBase<xpMtxDstParV0Config>>(instanceFactory::createInstance(name(), "uDstPP", "xpMtxDstPar", "v0", "xpMtxLit")))
