...
// GENERATED_CODE_PARAM --block=xpMtxLitTop
...
class xpMtxLitTopConfig : public testBenchConfigBase
{
public:
    virtual ~xpMtxLitTopConfig() override = default; // Explicit Virtual Destructor
...
protected:
    ...
    std::shared_ptr<blockBase> createTbTop(void) { return instanceFactory::createInstance("", "tb", "xpMtxLitTopTestbench", "", "xpMtxLit"); }
public:
// GENERATED_CODE_END
...
// === Testbench config registration (xpMtxLitTopConfig) ===
...
void register_xpMtxLitTopConfig() {
    testBenchConfigFactory::registerTestBenchConfig("xpMtxLitTop", [](std::string) -> std::shared_ptr<testBenchConfigBase> { return static_cast<std::shared_ptr<testBenchConfigBase>> (std::make_shared<xpMtxLitTopConfig>());}, is_default_testbench_v<xpMtxLitTopConfig>);
}

namespace {
[[maybe_unused]] A2C_REGISTRATION_RETAIN int _xpMtxLitTopConfig_registered = (register_xpMtxLitTopConfig(), 0);
} // namespace
