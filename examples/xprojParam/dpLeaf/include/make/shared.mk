...
REPO_ROOT = $(A2C_ROOT)/examples/xprojParam/dpLeaf

PROJECTNAME = xpDpLeaf
...
TB_TOP_MODULE = xpDpLeaf
HDL_TOP_MODULE = xpDpLeaf

A2C_PRJ_YAML = $(REPO_ROOT)/prj/yaml/xpDpLeafProject.yaml
