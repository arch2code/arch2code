#ifndef XPRTWRAP_HDL_SC_WRAPPER_H_
#define XPRTWRAP_HDL_SC_WRAPPER_H_
...
class xpRtWrap_hdl_sc_wrapper: public sc_module, public blockBase, public xpRtWrapBase<Config> {
...
public:
    ...
    using xpRtWrap_hdl_sc_wrapper_self_t = xpRtWrap_hdl_sc_wrapper<DUT_T, Config>;
    SC_HAS_PROCESS (xpRtWrap_hdl_sc_wrapper_self_t);

    xpRtWrap_hdl_sc_wrapper(sc_module_name modulename, const char *variant, blockBaseMode bbMode) :
        sc_module(modulename),
        blockBase("xpRtWrap_hdl_sc_wrapper", name(), bbMode),
...
#endif // XPRTWRAP_HDL_SC_WRAPPER_H_
