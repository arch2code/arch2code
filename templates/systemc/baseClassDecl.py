...
def render(args, prj, data):
    ...
    #
    # The predicate is "non-templated" (no own `params:`) so parent containers
    # that are flagged isParameterizable solely because parameterizable
    # structures transit their surface (e.g., `ip_top`) also receive the
    # force-link anchor.
    if not hasOwnParams:
        out.append('')
        out.append(f'// Force-link function (active modules-mode anchor).')
